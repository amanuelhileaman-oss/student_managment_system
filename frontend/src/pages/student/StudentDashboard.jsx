      ...
      >
        <form onSubmit={handleSubmitWork} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="p-4 border-2 border-dashed border-emerald-400/60 dark:border-emerald-600/40 rounded-2xl bg-emerald-50/30 dark:bg-emerald-950/20 text-center hover:bg-emerald-50/60 transition-colors relative">
              <input
                type="file"
              ...
              {selectedFile ? (
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                    Click to select your completed coursework file
                  </p>
